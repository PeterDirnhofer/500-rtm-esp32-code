...
void vspiDacStart() {
  vspiDacInit();
  xTaskCreatePinnedToCore(vspiDacLoop, "vspiDacLoop", 10000, NULL, 3,
                          &handleVspiLoop, 1);
}
...
void vspiDacInit() {
  ...
  spi_device_interface_config_t devcfgDacX = {.command_bits = 8,
                                              .address_bits = 0,
                                              .dummy_bits = 0,
                                              .mode = 0,
                                              .clock_source =
  ...
  spi_device_interface_config_t devcfgDacY = {.command_bits = 8,
                                              .address_bits = 0,
                                              .dummy_bits = 0,
                                              .mode = 0,
                                              .clock_source =
  ...
  spi_device_interface_config_t devcfgDacZ = {.command_bits = 8,
                                              .address_bits = 0,
                                              .dummy_bits = 0,
                                              .mode = 0,
                                              .clock_source =
  ...
  gpio_config_t io_conf = {.pin_bit_mask = (1 << GPIO_CS_VSPI_DACX) |
                                           (1 << GPIO_CS_VSPI_DACY) |
                                           (1 << GPIO_CS_VSPI_DACZ),
...
void vspiSendDac(uint16_t dacValue, uint16_t *tx_buffer,
                 spi_device_handle_t dacDeviceHandle) {
